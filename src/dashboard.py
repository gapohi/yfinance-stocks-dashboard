...
def dash_app():
    ...
    # create a list to store stock components
    stock_components = []

    # loop through the data and append the components for each stock
    for i in data:
        stock_components.append(
            html.Div([
                ...
                html.Div([create_metric_chart(i['price'], 'Closed Price')], style={'marginTop': '20px'}),
                ...
                html.Div([create_metric_chart(i['volume'], 'Closed Volume')], style={'marginTop': '20px'}),
    ...
    # set the layout with the list of stock components
    app.layout = html.Div([
        create_header(),  # adding the header at the top
        html.Div(stock_components, style={
            'display': 'flex',
